/*
- Store the first element as the smallest value you've sen so far.
- Compare this item to the next item in the array until you find
a smaller number.
- If a smaller number is found, dsignate that smaller number to
...
- Repeat this with the next element until the array is sorte.
*/
